...
class Creator(TranslatableModel):
    ...
    def __str__(self):
        return self.safe_translation_getter("name", any_language=True) or f"Creator {self.pk}"
...
class Book(TranslatableModel):
    ...
    def __str__(self):
        return self.safe_translation_getter("title", any_language=True) or f"Book {self.pk}"
...
class Character(TranslatableModel):
    ...
    def __str__(self):
        return self.safe_translation_getter("name", any_language=True) or f"Character {self.pk}"
