...
from homepage.views.about_views import (
    ...
    HistoryEventListAPIView,
    LicensePageDetailAPIView,
)
from homepage.views.resource_views import (
    ResourceCategoryListAPIView,
    ResourceListAPIView,
...
from homepage.views.gallery_views import (
    GalleryCategoryListAPIView,
    GalleryItemListAPIView,
    GalleryItemDetailAPIView,
)

from homepage.views.revalidate_views import revalidate_cache

urlpatterns = [
    # Global
    path(
        "global/sitetitle/", SiteTitleDetailAPIView.as_view(), name="sitetitle-detail"
    ),
    path(
        "global/navigation/",
        NavigationGroupListAPIView.as_view(),
        name="navigation-list",
    ),
    path(
        "global/footer-sections/",
        FooterSectionListAPIView.as_view(),
        name="footer-sections-list",
    ),
    path(
        "global/family-sites/",
        FamilySiteListAPIView.as_view(),
        name="family-sites-list",
    ),
    path(
        "global/copyright/", CopyrightDetailAPIView.as_view(), name="copyright-detail"
    ),
    # Home
    ...
    path(
        "about/creators/<slug:slug>/",
        CreatorDetailAPIView.as_view(),
        name="creator-detail",
    ),
    path(
        "about/books/categories/",
        BookCategoryListAPIView.as_view(),
    ...
    path(
        "about/characters/<slug:slug>/",
        CharacterDetailAPIView.as_view(),
        name="character-detail",
    ),
    path("about/history/", HistoryEventListAPIView.as_view(), name="historyevent-list"),
    path(
        "about/licenses/", LicensePageDetailAPIView.as_view(), name="licensepage-detail"
    ),
    # Resources
    path(
        "resources/categories/",
        ResourceCategoryListAPIView.as_view(),
        name="resource-category-list",
    ),
    path("resources/", ResourceListAPIView.as_view(), name="resource-list"),
    path(
        "resources/<int:id>/", ResourceDetailAPIView.as_view(), name="resource-detail"
    ),
    # News
    path(
        "news/categories/", NewsCategoryListAPIView.as_view(), name="news-category-list"
    ),
    ...
    path(
        "gallery/categories/",
        GalleryCategoryListAPIView.as_view(),
        name="gallery-category-list",
    ),
    path("gallery/", GalleryItemListAPIView.as_view(), name="gallery-list"),
    path(
        "gallery/<int:id>/", GalleryItemDetailAPIView.as_view(), name="gallery-detail"
    ),
    # 캐시 재검증 API
    path("revalidate-cache/", revalidate_cache, name="revalidate_cache"),
]
